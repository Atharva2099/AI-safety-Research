        ...
        for batch_start in range(0, len(indices), args.batch_size):
            ...
            for record in records:
                ...
                for condition in ["neutral", "pressure"]:
                    margins[condition] = sum(
                        record["scores"][condition][label][label]
                        - record["scores"][condition][label][incorrect_label if label == correct_label else correct_label]
                        for label in [correct_label, swapped_label]
                    ) / 2
                neutral_is_correct = margins["neutral"] > 0
                pressure_is_correct = margins["pressure"] > 0
                ...
                output.write(json.dumps({
                    ...
                    "neutral_margin": margins["neutral"],
                    "pressure_margin": margins["pressure"],
